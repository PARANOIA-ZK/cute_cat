...
package com.paranoia.sourcecode.java.util.concurrent.locks;
...
public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements java.io.Serializable {
    ...
    static final class Node {
         ...
         * mode.
         * 链接到正在等待状态的下一个节点，或特殊值SHARED。
         * 因为条件队列只有在独占模式下才能访问，所以我们只需要一个简单的链接队列来在节点等待条件时保存节点。
         * 然后将它们转移到队列中重新获取。
     ...
     * @return node's predecessor（节点的前任）
     */
