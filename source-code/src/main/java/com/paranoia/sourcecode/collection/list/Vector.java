...
/**
 * 从Java 2平台v1.2开始，这个类被修改为实现{@link List}接口，使它成为Java集合框架。
...
public class Vector<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
     ...
     * 如果容量增量小于或等于零，则每次需要增长时，vector的容量就增加一倍。
     *
     * @serial
     */
     ...
     * capacity increment.
     *
     * @param initialCapacity   elementData的初始化大小
     * @param capacityIncrement 当向量溢出时vector增加的量
